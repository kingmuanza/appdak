...
public class PtConstants {
    ...
    public static final int PT_FWITEM_AUTHENTIFY_ID = 3;
    public static final int PT_FWITEM_AUTHENTIFY_KEY = 4;
    public static final int PT_FWITEM_CFGFLAGS = 1;
    public static final int PT_FWITEM_CFGSESSION = 2;
    public static final int PT_FWITEM_COMM_CFG = 9;
    public static final int PT_FWITEM_GPIO_CFG = 7;
    public static final int PT_FWITEM_IMGFORMATS_CFG = 14;
    public static final int PT_FWITEM_LED_CFG = 15;
    public static final int PT_FWITEM_POA_CFG = 12;
    public static final int PT_FWITEM_PSW_CFG = 8;
    public static final int PT_FWITEM_SECURITY_CFG = 10;
    public static final int PT_FWITEM_SETCFG_KEY = 5;
    public static final int PT_FWITEM_SYSTEMINFO_CFG = 11;
    public static final int PT_FWITEM_TCD50V3_CFG = 13;
    public static final int PT_FWITEM_UPDATE_KEY = 6;
